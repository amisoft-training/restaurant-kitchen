package com.amisoft.restaurantkitchen.config;

import com.amisoft.restaurantkitchen.Listener.CreateOrderListener;
...
public class OrderEventListenerConfig {
    ...
    SimpleMessageListenerContainer container(ConnectionFactory connectionFactory, MessageListenerAdapter listenerAdapter) {
        ...
        container.setQueueNames(KitchenConstant.ORDER_QUEUE_NAME);
